...
<script>
	...
	export default {
		...
		methods: {
			...
			// 导入
			download() {
				var url = this.basic_url + '/api-apps/app/inspectionPro/importExcTemplete?access_token='+sessionStorage.getItem('access_token');
